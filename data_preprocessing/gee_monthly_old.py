...
def run_gee_monthly_feature_export(cfg: Dict[str, Any]) -> pd.DataFrame:
    ...
    def mask_l8(img):
        ...
        # 1 dilated cloud, 2 cirrus, 3 cloud, 4 cloud shadow, 5 snow, 7 water
        mask = (
